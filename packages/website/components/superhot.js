  ...
  return (
    <>
      ...
      <div className="bg-peach relative overflow-hidden text-center">
        <div className="circle-container overflow-hidden -mt-[80px]">
          <Circles />
        </div>
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 lg:py-32 mt-12">
          <div className="relative px-6">
            <h1 className="font-open-sans text-3xl font-bold text-black lg:text-2xl">
          ...
          <div className="px-6 max-w-6xl mx-auto mt-12">
            <div className="bg-white p-16 border-2 border-black">
              <img
              ...
              <h4 className="text-2xl font-semibold max-w-4xl mx-auto">
